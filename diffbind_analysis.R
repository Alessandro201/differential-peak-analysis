...
p <- add_argument(p, "--tissue-contrast", help = "Set the baseline condition, eg. the denominator in the fold change. You should have two distinct tissues, and you should specify the one you want as baseline", default = "BULK", type = "character", nargs = 1)
...
p <- add_argument(p, "--minOverlap",
    ...
    default = 2, type = "number", nargs = 1
)
p <- add_argument(p, "--consensus",
    help = "Specify a samplesheet containing the consensus peakset for each of the TISSUE in the Samplesheet. It will be used instead of the one generated by diffbind. Incompatible with --minOverlap.",
